...
mixes=(
"diffusion_1024_1024-1-57-29-1.0-1.0-0.25-0.0923146137935218 resnet152-8-43-50104-1.0-1.0-0.25-278.36"
...
"gpt-1-43-40-1.0-1.0-0.25-0.16192860916956147 densenet169-4-29-45732-1.0-1.0-0.25-254.07"
"resnet50-32-57-250380-1.0-1.0-0.25-1391.97 densenet161-4-29-42154-1.0-1.0-0.25-234.19"
)
...
mkdir -p ${git_dir}/results/gpulets-ablation-arrival-results/load-100
cp -r ${git_dir}/results/a100/* ${git_dir}/results/gpulets-ablation-arrival-results/load-100/
