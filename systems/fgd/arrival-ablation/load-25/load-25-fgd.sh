...
"gpt-1-4-40-0.25-0.25-0.25-0.22192860916956147 vgg11-4-3-134037-0.25-0.25-0.25-744.65"
"resnet50-1-4-250380-0.25-0.25-0.25-1391.97 whisper-16-3-708-0.25-0.25-0.25-3.9362878866995845"
)
...
mkdir -p ${git_dir}/results/fgd-ablation-arrival-results/load-25
cp -r ${git_dir}/results/a100/* ${git_dir}/results/fgd-ablation-arrival-results/load-25/
